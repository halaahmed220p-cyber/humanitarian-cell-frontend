...
export default function ProgramDetail({ programs }) {
  ...
  // جلب البيانات الأساسية للبرنامج
  let program = programs[programId]

  // تعديل وتخصيص برنامج صرح مباشرة هنا ليطابق الهوية البصرية والتنمية المستدامة والمناخ
  if (programId === 'sarh' && program) {
    program = {
      ...
      description: "برنامج صرح هو الركيزة الاستراتيجية للتنمية المستدامة والعمل المناخي الشامل في اليمن. يتخصص البرنامج في تنفيذ وتطوير مشاريع البنية التحتية والخدمية في كافة القطاعات الحيوية، شملت قطاعات المياه والصحة والتعليم والطاقة المتجددة والطرق، لضمان استدامة المجتمعات ومواجهة التغيرات المناخية.",
      color: "#2563eb", // اللون الأزرق الرسمي المستوحى من الهوية البصرية الجديدة
      colorLight: "#93c5fd",
      ...
      impacts: [
        {
          ...
          desc: "إنشاء محطات الطاقة الشمسية وأنظمة إمداد المياه النظيفة للمجتمعات المتضررة.",
          icon: "💧"
        },
        {
          title: "الصحة والتعليم المستدام",
          desc: "تأهيل وبناء المرافق الصحية والتعليمية بمعايير صديقة للبيئة ومقاومة للمناخ.",
          icon: "🏫"
        },
        {
          title: "البنية التحتية والطرق",
          desc: "تطوير الطرق وشبكات الربط الحيوي لتسهيل حركة التجارة والخدمات المحلية.",
          icon: "🛣️"
        }
      ],
      projects: [
        {
          id: "sarh-1",
          title: "مشروع الطاقة الشمسية للمياه المستدامة",
          location: "مختلف المحافظات",
          date: "2026",
          desc: "تشغيل آبار المياه بالطاقة النظيفة لتوفير المياه المستدامة للمجتمعات المحلية وتقليل الانبعاثات.",
          progress: 90,
          beneficiaries: "80,000 مستفيد",
          status: "active",
          icon: "☀️"
        },
        {
          id: "sarh-2",
          title: "تأهيل البنية التحتية التعليمية والصحية",
          location: "المديريات المستهدفة",
          date: "2026",
          desc: "إعادة بناء وتجهيز المدارس والمراكز الصحية المتضررة وتزويدها بأنظمة الطاقة المتجددة.",
          progress: 75,
          beneficiaries: "120,000 مستفيد",
          status: "ongoing",
          icon: "🏥"
        }
      ],
      timeline: [
        {
          date: "يناير 2026",
          title: "إطلاق استراتيجية العمل المناخي",
          desc: "توسيع نطاق مشاريع صرح ليشمل قطاعات الطاقة المتجددة والمياه وصمود المجتمعات."
        },
        {
          date: "مشاريع سابقة",
          title: "تطوير البنية التحتية الأساسية",
          desc: "إنجاز عشرات المشاريع الخدمية في قطاعات الطرق والتعليم والصحة بمختلف المحافظات."
        }
      ]
    };
  }
